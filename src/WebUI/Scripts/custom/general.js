...
jQuery(document).ready(function () {
    ...
    jQuery('.notification a').click(function () {
        ...
        if (!jQuery('.noticontent').is(':visible')) {
            jQuery.post(url, function (data) {
                t.parent().append('<div class="noticontent" style="width:500px">' + data + '</div>');
            });
    ...
    jQuery('#lnkMessages').click(function () {
        var t = jQuery(this);
        var url = t.attr('href');
        alert('');
        return false;
    ...
    jQuery('.togglemenu').click(function () {
        ...
        if (!jQuery(this).hasClass('togglemenu_collapsed')) {
            ...
            jQuery('div.vernav2.iconmenu div.widgetcontent').hide(); //Fix to show widgetcontent
            ...
            jQuery('div.vernav2.iconmenu div.widgetcontent').show(); //Fix to hide widgetcontent
