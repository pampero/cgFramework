...
if ("undefined" != typeof inFIF) inIframe = inFIF ? -1 : inIframe;
    ...
    if (!inIframe) {
	document.write('<div id="eplParentContainer208733"></div>');eplDiv = document.getElementById("eplParentContainer208733");
    } else {
    var cF;
	if (inIframe > 0) {
    ...
    if (cF) {
	    ...
	    eplDoc.eplF[ 208733 ] = cF;
	    if (inIframe<0) {
		    cF.height = '0px'; cF.width = '0px';
		    cF.style.height = '0px'; cF.style.width = '0px'
		    cF.style.display = 'none';		    
	    }
	    eplDiv = eplDoc.createElement('div'); eplDiv.name = "eplParentContainer208733"; eplDiv.id = "eplParentContainer208733";
...
document.write('<object width="200" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" height="110" border="0" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0"><param value="always" name="allowscriptaccess"><param value="http://ar-pri2.img.e-planning.net/esb/4/1/4cde/46b21ec2077ec566.swf" name="movie"><param value="autohigh" name="quality"><param value="true" name="LOOP"><param value="opaque" name="wmode"><param value="clickTag=http://ads.e-planning.net/ei/3/4d63/6ad6b164305a4b99%3fct%3d1%26pb%3de417f1c751306590%26fi%3d9e4402601b5d8969%26rnd%3d772513178848&bannerId=208733" name="flashvars"><embed width="200" allowscriptaccess="always" src="http://ar-pri2.img.e-planning.net/esb/4/1/4cde/46b21ec2077ec566.swf" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" height="110" loop="true" border="0" wmode="opaque" flashvars="clickTag=http://ads.e-planning.net/ei/3/4d63/6ad6b164305a4b99%3fct%3d1%26pb%3de417f1c751306590%26fi%3d9e4402601b5d8969%26rnd%3d772513178848&bannerId=208733" type="application/x-shockwave-flash" quality="autohigh"></embed></object>');
function eplResizeFrame() {
    var eplFrame = document.eplF ? document.eplF[ 208733 ] : null;
